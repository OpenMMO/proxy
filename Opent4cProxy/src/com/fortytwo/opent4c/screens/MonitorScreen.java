...
public class MonitorScreen implements Screen{
	...
	public MonitorScreen(SpriteBatch batch) {
		stage = new Stage();
		this.batch = batch;
	...
	private void addText() {
	    ...
	    screenTitleLabel = new Label("MONITOR", labelStyle);
	    ...
	    viewMonitorButton = new TextButton("View Pak Monitor", bluButtonStyle);
	...
	private void setConsolePosition() {
		...
		for (int i = 0 ; i < consoleLines.size() ; i++){
		    consoleLines.get(i).setPosition(getXPos(19), getYPos(92-offset));
		    offset += 3;
		}
	}
