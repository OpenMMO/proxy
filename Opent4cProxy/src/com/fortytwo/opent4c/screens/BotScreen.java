...
public class BotScreen implements Screen{
	...
	private Label notImplementedLabel;
	private Label screenTitleLabel;

	
	public BotScreen(SpriteBatch batch) {
		stage = new Stage();
		this.batch = batch;
	...
	private void addText() {
	    ...
	    notImplementedLabel = new Label("Not Implemented yet... What did you expect? ^^", labelStyle);
	    screenTitleLabel = new Label("BOTS", labelStyle);
	    ...
	    viewInfosButton = new TextButton("View Informations", buttonStyle);
	    ...
	    viewBotsButton = new TextButton("View Bots Informations", bluButtonStyle);
	    addListeners();
	...
	public void render(float delta) {
	    ...
	    notImplementedLabel.setPosition(getXPos(50), getYPos(50));
		...
		shapes.line(0, getYPos(67), getXPos(18), getYPos(67));
