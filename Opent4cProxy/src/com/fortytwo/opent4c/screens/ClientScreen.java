...
public class ClientScreen implements Screen{
	...
	public ClientScreen(SpriteBatch batch) {
		stage = new Stage();
		this.batch = batch;
	...
	private void addText() {
	    ...
	    screenTitleLabel = new Label("CLIENTS", labelStyle);
	    ...
	    viewClientsButton = new TextButton("View Clients Informations", bluButtonStyle);
